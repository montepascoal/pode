    ...
    return queryInterface.bulkInsert('CONFIG_EMPLOYEES_DEPARTMENTS', [
      {
        ...
        depDescription:
          'Departamento encarregado de serviços relacionados a TI',
        depCreated: new Date(),
        depUpdated: new Date(),
        depDeleted: null,
      },
      ...
      },
      {
        ...
        depDescription:
          'Departamento encarregado de serviços relacionados a administração',
        depCreated: new Date(),
        depUpdated: new Date(),
        depDeleted: null,
      },
      {
        ...
        depName: 'Financeiro',
        depDescription:
          'Departamento encarregado de serviços relacionados ao financeiro',
        depCreated: new Date(),
        depUpdated: new Date(),
        depDeleted: null,
      },
