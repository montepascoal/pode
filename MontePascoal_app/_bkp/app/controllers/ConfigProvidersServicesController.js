...
const { CONFIG_PROVIDERS_SERVICES } = require('../models');

const LogsController = require('./LogsController');
const UsersController = require('./UsersController');

//  ------------------------------------------------------------------------------------------------------------------------------------- Class API -----
class ConfigProvidersServicesController {
  ...
  servicesPost = async ({body,params}, res) => {
    ...
    try {
      ...
      const resServicesPost = await CONFIG_PROVIDERS_SERVICES.create(objData.data);
  ...
  servicesGetAll = async ({body,params}, res) => {
    ...
    try {
      ...
      // }
      const resServicesGetAll = await CONFIG_PROVIDERS_SERVICES.findAll({
        where: filter,
        order: [
          ['id', 'ASC'],
        ],
  ...
  servicesGetId = async ({body,params}, res) => {
    ...
    try {
      ...
      const resServicesGetId = await CONFIG_PROVIDERS_SERVICES.findByPk(objData.idMain,{
        // include: [
          // 'COMPANIES',
          // 'CONFIG_COUNTRIES',
          // 'CONFIG_STATES',
...
module.exports = new ConfigProvidersServicesController(); 