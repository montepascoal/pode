...
class UsersController {
  ...
  usersPost = async ({body,params}, res) => {
    ...
    try {
      ...
      if (objResAuth.resData.useKeyCompany !== 0) {
        // Verifica se o usuário pertente a empresa que possui permissão
  ...
  usersGetLogs = async ({body,params}, res) => {
    ...
    try {
      ...
      if (resUsersGetLogs.length > 0) {
        LogsController.logsCreate(useId, perId, logMsg, `=> [${useId}] # Usuário (Logs): Listagem geral ## [${objData.id}] ${resUsersGetId.useNickname}`, objData.id);
  ...
  usersPatchCompanies = async ({body,params}, res) => {
    ...
    try {
      ...
      LogsController.logsCreate(useId, perId, logMsg, `=> [${useId}] # Usuário: Atualizado [Empresa] ## [${objData.id}] ${resUsersGetId.useNickname}`, objData.id);
  ...
  usersPatchPassword = async ({body,params}, res) => {
    ...
    try {
      ...
      LogsController.logsCreate(useId, perId, logMsg, `=> [${useId}] # Usuário: Atualizado [Password] ## [${objData.id}] ${resUsersGetId.useNickname}`, objData.id);
    ...
    try {
      ...
      if (resUsersGetId) {
        ...
        if (!resUsersGetId.usePasswordReset) {
          return utils.resError(409, "API ==> Controller => usersPermission -> Atualização não autorizada", null, res );
        }
      } else {
      ...
      LogsController.logsCreate(useId, perId, logMsg, `=> [${useId}] # Usuário: Atualizado [Password Reset] ## [${objData.id}] ${resUsersGetId.useNickname}`, objData.id);
  ...
  usersPatchPasswordGenerate = async ({body,params}, res) => {
    ...
    try {
      ...
      LogsController.logsCreate(useId, perId, logMsg, `=> [${useId}] # Usuário: Atualizado [Password Generate] ## [${objData.id}] ${resUsersGetId.useNickname}`, objData.id);
  ...
  usersPatchPermission = async ({body,params}, res) => {
    ...
    try {
      ...
      LogsController.logsCreate(useId, perId, logMsg, `=> [${useId}] # Usuário: Atualizado [Permission] [${body.usePermission}] ## [${objData.id}] ${resUsersGetId.useNickname}`, objData.id);
  ...
  usersPatchNickname = async ({body,params}, res) => {
    ...
    try {
      ...
      LogsController.logsCreate(useId, perId, logMsg, `=> [${useId}] # Usuário: Atualizado [Nickname] [${resUsersGetId.useNickname}] ## [${objData.id}] ${objData.data.useNickname}`, objData.id);
  ...
  usersPutClients = async ({body,params}, res) => {
    ...
    try {
      ...
      LogsController.logsCreate(useId, perId, logMsg, `=> [${useId}] # Usuário: Atualizado [Nickname/Empresa] [${resUsersGetId.useNickname}] ## [${objData.id}] ${objData.data.useNickname}`, objData.id);
  ...
  usersValidate = async ({body,params}, res) => {
    ...
    try {
      ...
      if (resUsersGetId) {
        ...
        LogsController.logsCreate(useId, perId, logMsg, `=> [${useId}] # Usuário: Validação ## [${objData.id}] ${resUsersGetId.useNickname}`, objData.id);
  ...
  usersValidatePermission = async ({body,params}, res) => {
    ...
    try {
      ...
      if (resUsersGetId) {
        ...
        LogsController.logsCreate(useId, perId, logMsg, `=> [${useId}] # Usuário: Validação [Permission] [${objData.data.usePerId}] ## [${objData.id}] ${resUsersGetId.useNickname}`, objData.id);
