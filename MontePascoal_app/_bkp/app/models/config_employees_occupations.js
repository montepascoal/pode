...
module.exports = (sequelize, DataTypes) => {
  const CONFIG_EMPLOYEES_OCCUPATIONS = sequelize.define('CONFIG_EMPLOYEES_OCCUPATIONS', {
  ...
  CONFIG_EMPLOYEES_OCCUPATIONS.associate = function (models) {
    models.CONFIG_EMPLOYEES_OCCUPATIONS.belongsTo(models.CONFIG_EMPLOYEES_DEPARTMENTS, {
      onDelete: "CASCADE",
      foreignKey: "depId",
      targetKey: "id",
