  ...
  post = async ({ body, params }, res) => {
    ...
    try {
      ...
      LogsController.logsCreate(
        ...
        `=> [${useId}] # Config: Colaboradores: Funções: Cadastrado ## [${objData.idSecondary}] ${objData.data.occName}`,
        objData.idSecondary
      );
  ...
  getAll = async ({ body, params }, res) => {
    ...
    try {
      ...
      LogsController.logsCreate(
        ...
        `=> [${useId}] # Config: Colaboradores: Funções: Listagem geral ## [geral]`,
        null
      );
      return utils.resSuccess(
        'API ==> Controller => occupationsGetAll -> Success',
    ...
    try {
      ...
      if (resOccupationsGetId) {
        LogsController.logsCreate(
          ...
          `=> [${useId}] # Config: Colaboradores: Funções: Consultado ## [${objData.idSecondary}] ${resOccupationsGetId.occName}`,
          objData.idSecondary
        );
        return utils.resSuccess(
          'API ==> Controller => occupationsGetId -> Success',
  ...
  put = async ({ body, params }, res) => {
    ...
    try {
      ...
      LogsController.logsCreate(
        ...
        `=> [${useId}] # Config: Colaboradores: Funções: Atualizado ## [${objData.idSecondary}] ${objData.data.occName}`,
        objData.idSecondary
      );
      return utils.resSuccess(
        'API ==> Controller => occupationsPut -> Success',
